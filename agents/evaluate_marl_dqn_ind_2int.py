...
# Run this script from agents/ — matches train_marl_dqn_ind_2int.py's config.
config = {
...
models = {
    agent: DQN.load(f"models/marl_dqn_ind_2int_{agent}_260k")
...
print("=== Evaluating MARL DQN (independent) — 2 Intersection Network ===")
...
with open("results/marl_dqn_ind_2int_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to results/marl_dqn_ind_2int_results.json")