...
print("=== MARL DQN with Parameter Sharing — 6 Intersection Network ===")
...
print(f"Shared model:    ONE DQN network for all 6 agents")
...
checkpoint = CheckpointCallback(
    ...
    name_prefix = "marl_dqn_ps_6int"
)

shared_model.learn(
    total_timesteps = 260000,
    callback        = checkpoint,
    tb_log_name     = "marl_dqn_ps_6int"
)

# ── Save ───────────────────────────────────────────────────────────────
shared_model.save("models/marl_dqn_ps_6int_260k")
print("\nTraining complete.")
print("Saved: models/marl_dqn_ps_6int_260k.zip")
