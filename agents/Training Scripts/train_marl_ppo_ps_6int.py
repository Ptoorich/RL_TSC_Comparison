...
# The other 5 agents use the same shared model via shared_model reference
...
print("=== MARL PPO with Parameter Sharing — 6 Intersection Network ===")
...
print(f"Shared model:    ONE PPO network for all 6 agents")
...
checkpoint = CheckpointCallback(
    ...
    name_prefix = "marl_ppo_ps_6int"
)

shared_model.learn(
    total_timesteps = 260000,
    callback        = checkpoint,
    tb_log_name     = "marl_ppo_ps_6int"
)

# ── Save ───────────────────────────────────────────────────────────────
shared_model.save("models/marl_ppo_ps_6int_260k")
print("\nTraining complete.")
print("Saved: models/marl_ppo_ps_6int_260k.zip")
