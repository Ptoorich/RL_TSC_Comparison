...
print("=== MARL PPO with Parameter Sharing — 4 Intersection Network ===")
...
print(f"Shared model:    ONE PPO network for all 4 agents")
...
shared_model.learn(
    ...
    callback        = checkpoint,
    tb_log_name     = "marl_ppo_ps_4int"
)

# ── Save ───────────────────────────────────────────────────────────────
shared_model.save("models/marl_ppo_ps_4int_260k")
print("\nTraining complete.")
