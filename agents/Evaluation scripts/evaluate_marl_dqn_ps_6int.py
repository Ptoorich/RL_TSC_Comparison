...
# Run this script from agents/ — matches train_marl_dqn_ps_6int.py's config.
config = {
...
shared_model = DQN.load("models/marl_dqn_ps_6int_260k")
...
print("=== Evaluating MARL DQN (parameter sharing) — 6 Intersection Network ===")
...
with open("results/marl_dqn_ps_6int_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to results/marl_dqn_ps_6int_results.json")