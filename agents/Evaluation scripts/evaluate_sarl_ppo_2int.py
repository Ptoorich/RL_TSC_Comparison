...
print("=== Evaluating SARL PPO — 2 Intersection Network ===")
...
with open("results/sarl_ppo_2int_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to results/sarl_ppo_2int_results.json")