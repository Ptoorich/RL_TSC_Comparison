...
# Run this script from agents/ — matches train_sarl_ppo_4int.py's config.
config = {
...
# ── Load trained model ──────────────────────────────────────────────────
# NOTE: train_sarl_ppo_4int.py saves directly as "sarl_ppo_4int_260k.zip"
# (no models/ folder) — update this path if you moved it since.
MODEL_PATH = "sarl_ppo_4int_260k"
...
print("=== Evaluating SARL PPO — 4 Intersection Network ===")
...
with open("results/sarl_ppo_4int_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to results/sarl_ppo_4int_results.json")