...
# Run this script from agents/ — matches train_marl_ppo_ind_6int.py's config.
config = {
...
# ── Load each agent's final model ────────────────────────────────────────
models = {
    agent: PPO.load(f"models/marl_ppo_ind_6int_{agent}_260k")
...
print("=== Evaluating MARL PPO (independent) — 6 Intersection Network ===")
...
with open("results/marl_ppo_ind_6int_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("\nResults saved to results/marl_ppo_ind_6int_results.json")